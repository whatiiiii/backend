...
<tr>
   ...
   <td>
      <input name='writer' readonly value='${content.writer}'/>
   </td>
</tr>

<tr>
	<td align='center'>EMAIL</td>
	<td><input name='email' value="${content.email}"/></td>
</tr>

<tr>
	<td align='center'>SUBJECT</td>
	<td><input name='subject' value="${content.subject}"/></td>
</tr>
			
<tr>
	<td align='center'>CONTENT</td>
	<td><textarea id='ta' name='content' rows='15' cols='70'>${content.content}</textarea></td>
</tr>
<tr>
